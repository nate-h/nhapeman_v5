...
export const projects: Project[] = [
  {
    ...
    fullDescription: (
      <>
        ...
        <ol>
          <li>
            <strong>combo_board:</strong> Uses both spectrograms and features to render a grid of squares. Each
          ...
          <li><strong>debug:</strong> Shows all features generated for current source separation plan.</li>
          <li><strong>spectrogram:</strong> Shows all spectrograms generated for current source separation plan.</li>
          <li>
            <strong>concentric_squares:</strong> Uses the source separated spectrograms to render concentric square
          ...
          <li><strong>stacked_equalizers:</strong> Show all frequencies heard with no adjustments.</li>
          <li>
            <strong>checkerboard:</strong> same as combo_board but with no use of features and much less filtering.
          </li>
        </ol>
      </>
    ),
