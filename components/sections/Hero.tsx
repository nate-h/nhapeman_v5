    ...
    <section id="home" className="w-full relative min-h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-20 text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#contact"
            className="px-8 py-3 bg-transparent border-2 border-emerald-400 hover:border-cyan-300 hover:bg-emerald-900/30 rounded-lg font-semibold transition-all duration-300"
          >
            Get In Touch
          </a>
        </div>
